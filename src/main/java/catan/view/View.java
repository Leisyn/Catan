...
public class View {
	...
	public View(Scanner sc) {	
		...
		JButton lancerDe = new JButton("Lancer les d�s");
		...
		// Le bouton quatreIA est mis en place dans la m�thode changeNbJoueurEtPasse, dans Controleur
		...
		construireColonieInitiale.addActionListener(event -> {
			...
			descriptifJeu.setText("Veuillez cliquer sur la colonie � construire.");
		...
		construireRouteInitiale.addActionListener(event -> {
			construireRouteInitiale.setEnabled(false);
			descriptifJeu.setText("Veuillez cliquer sur la route � construire.");
		...
		passerPhaseConstruction = new JButton("Passer � la phase de construction");

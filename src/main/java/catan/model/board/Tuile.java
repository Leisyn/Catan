...
public class Tuile {
	...
	public Tuile(int type, int jeton, boolean voleurEstIci) {
		...
		if (type < 0 || type > 7)
			throw new IllegalArgumentException("Impossible de cr�er la tuile : type donn� inconnu.");
		if (jeton < 2 || jeton > 12)
			throw new IllegalArgumentException("Impossible de cr�er la tuile : jeton non atteignable.");
		if (jeton == 7)
			throw new IllegalArgumentException("Impossible de cr�er la tuile : une tuile ne peut pas avoir un jeton �gal � 7.");
	...
	public Tuile(int type, boolean voleurEstIci) {
		if (type != 0 && type != 1 && type != 7)
			throw new IllegalArgumentException("Impossible de cr�er la tuile : type donn� non correspondant.");
